                        ...
                        if (addTaskDialog.getDateField().matches("") &&
                            ...
                            if (!addTaskDialog.getDateField().matches("")
                                ...
                                if(addTaskDialog.getNotification()){
                                    ...
                                    setData(cursor.getCount(), DatabaseHelper.COL_ID);
                                    String id = getData();

                                    notification.showNotification(id, addTaskDialog.getDate(), addTaskDialog.getTime(), addTaskDialog.getDescription());
                                }
                            }
                        }
                    }
