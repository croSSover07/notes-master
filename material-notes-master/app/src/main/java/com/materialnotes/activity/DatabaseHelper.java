...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final int COL_NOTIFY= 8;
    public static final int COL_N_TIME= 9;
    ...
    public static final String CREATE_TABLE_QUERY =
            "CREATE TABLE " +
                    ...
                    Database.TasksTable.NOTIFY + " BOOLEAN," +
                    Database.TasksTable.N_TIME + " TEXT);";
    ...
    public static final String SELECT_BY_DATE_DESCENDING =
            "SELECT * FROM " + Database.TasksTable.TABLE_NAME +
                    " ORDER BY DATE(" + Database.TasksTable.RAW_DUE_DATE + ") DESC, n_time DESC;";

    public static final String SELECT_BY_DATE_ASCENDING =
            "SELECT * FROM " + Database.TasksTable.TABLE_NAME +
                    " ORDER BY DATE(" + Database.TasksTable.RAW_DUE_DATE + ") ASC, n_time ASC;";
    ...
    public void insertTask(String category, String task, String due_date,
                           String raw_due_date, boolean completed, boolean priority, boolean notify, String n_date){
        ...
        contentValues.put(Database.TasksTable.NOTIFY, notify);
        contentValues.put(Database.TasksTable.N_TIME, n_date);
    ...
    public void removeTask(int id){
        ...
        String updatingIndex =
                "UPDATE "+ Database.TasksTable.TABLE_NAME +
                        " SET "+Database.TasksTable.ID+"="+Database.TasksTable.ID +"-"+1+
                        " WHERE "+Database.TasksTable.ID+">"+id+";";

        writeDb.execSQL(updatingIndex);
        writeDb.close();
    }
     ...
     * @param notify defines notification
     * @param n_date is time of notification
     */
